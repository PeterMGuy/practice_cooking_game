  ...
  Street: {
    ...
    configObjects: {
      ...
      streetNpcD: {
        ...
        behaviorLoop: [
          { type: "stand", direction: "right", time: 1900, },
          { type: "stand", direction: "down", time: 2100, },
        ],
        talking: [
          {
            required: ["talkToSammy"],
            events: [
              { type: "textMessage", text: "Hey, Dev spea... oh.", faceHero: "streetNpcD" },
              { type: "textMessage", text: "Did I say something else earlier?", faceHero: "streetNpcD" },
            ]
          },
          {
            events: [
              { type: "textMessage", text: "Hey, Dev speaking here!", faceHero: "streetNpcD" },
              { type: "textMessage", text: "This was made for practice and is not finished. Hope you enjoy the game regardless!", faceHero: "streetNpcD" },
              { type: "addStoryFlag", flag: "talkToSammy" },
            ]
          },
        ]
      },
